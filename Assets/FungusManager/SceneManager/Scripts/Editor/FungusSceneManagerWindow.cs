...
namespace Fungus
{
    ...
    public class FungusSceneManagerWindow : FungusManagerWindow
    {
        ...
        override protected void OnGUI()
        {
            ...
            else
            {
                if (!sceneManagerIsLoaded)
                {
                    ...
                    LoadSceneButton("SceneManager", GetSceneAssetPath("SceneManager.unity"), OpenSceneMode.Single);
                    // load the SceneManager and place it on top
                    LoadSceneButton("SceneManager", GetSceneAssetPath("SceneManager.unity"), OpenSceneMode.Additive);
        ...
        protected void LoadSceneButton(string sceneName, string path, OpenSceneMode openSceneMode)
        {
